...
{
    public class FromBankCreditCardManager : IFromBankCreditCardService
    {
        ...
        public IDataResult<FromBankCreditCard> Add(AddCreditCardDto addCreditCardDto, string cardNumber, string expirationDate, string cvv)
        {
            ...
            {
                FromBankCreditCardID = addCreditCardDto.Id,
        ...
        {
            return new SuccessDataResult<FromBankCreditCard>(_creditCardDal.Get(c => c.FromBankCreditCardID == id));
        }
